...
const styles = StyleSheet.create({
  ...
  ktmBrand: { fontSize: 14, color: '#ff472f', fontWeight: '900', letterSpacing: 2, marginBottom: 10 },
  ...
  button: { width: '100%', backgroundColor: '#fa4727', padding: 15, borderRadius: 8, alignItems: 'center' },
